      ...
      <PageHeader
        ...
        actions={
          <div className="flex items-center gap-1.5">
            ...
            <HelpTooltip tooltipKey="risk-profiles-new" label="Create Risk Profile" side="left" />
          </div>
        }
      />
      <PageContainer>
          ...
          <div className="flex items-center justify-between">
            <div>
              <CardTitle className="flex items-center gap-1.5">
                Risk Profile List
                <HelpTooltip tooltipKey="risk-profiles-table" label="Risk Profiles" />
              </CardTitle>
            ...
            <div data-tour="filters" className="flex items-center gap-2">
              ...
              <HelpTooltip content="Filter risk profiles by assessment year." label="Year filter" />
            </div>
          </div>
        </CardHeader>
        <CardContent>

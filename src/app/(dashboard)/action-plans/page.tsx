    ...
    <>
      ...
      <Card data-tour="filters" className="p-4 bg-white border-slate-200">
        <div className="flex items-center gap-4">
          ...
          <HelpTooltip tooltipKey="action-plans-search" label="Search action plans" />
          ...
          <HelpTooltip tooltipKey="action-plans-status-filter" label="Status filter" />
        ...
        <Table>
          <TableHeader>
            <TableRow className="bg-slate-50">
              ...
              <TableHead className="font-semibold">
                <span className="inline-flex items-center gap-1.5">Progress <HelpTooltip tooltipKey="action-progress" label="Progress" /></span>
              </TableHead>
              <TableHead className="font-semibold">
                <span className="inline-flex items-center gap-1.5">Status <HelpTooltip tooltipKey="action-plans-status-filter" label="Status" /></span>
              </TableHead>

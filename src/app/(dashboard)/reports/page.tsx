    ...
    <>
      ...
      <PageContainer>
        <div className="space-y-6">
          {/* Quick Actions */}
          <div data-tour="filters" className="grid gap-6 md:grid-cols-3">
        <Card className="p-6 bg-white border-slate-200">
          ...
          <h3 className="font-semibold text-slate-900 flex items-center gap-1.5">
            Custom Report
            <HelpTooltip tooltipKey="reports-type" label="Report type & period" />
          </h3>
        ...
        <Card className="p-6 bg-white border-slate-200">
          ...
          <h3 className="font-semibold text-slate-900 flex items-center gap-1.5">
            Export Data
            <HelpTooltip tooltipKey="reports-export" label="Export" />
          </h3>
          <p className="text-sm text-slate-600 mt-2">
      ...
      {/* Report Templates */}
      <div data-tour="table">
        <h2 className="text-xl font-semibold text-slate-900 mb-4 flex items-center gap-1.5">
          Report Templates

      ...
      <PageHeader
        ...
        actions={
          <div className="flex items-center gap-1.5">
            ...
            <HelpTooltip tooltipKey="admin-divisions-new" label="Add Division" side="left" />
          </div>
        }
      />
      <PageContainer>
      ...
      <Card data-tour="filters">
        <CardContent className="p-4">
          <div className="flex items-center gap-2">
            ...
            <HelpTooltip content="Search divisions by name or code to find one quickly." label="Search divisions" side="left" />
          </div>
        </CardContent>
      </Card>
      ...
      <Card data-tour="table">
        <CardHeader>
          <CardTitle className="flex items-center gap-1.5">
            DLPP Divisions ({filteredDivisions.length})
            <HelpTooltip tooltipKey="admin-table" label="Divisions" />
          </CardTitle>
          <CardDescription>

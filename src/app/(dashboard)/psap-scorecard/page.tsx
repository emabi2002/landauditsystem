    ...
    <>
      <PageHeader
        ...
        actions={
          <div className="flex items-center gap-1.5">
            ...
            <HelpTooltip tooltipKey="psap-new" label="New Assessment" side="left" />
          </div>
        }
      />
      <PageContainer>
      ...
      <Tabs defaultValue="assessments" className="space-y-4">
        <div className="flex items-center gap-2">
          ...
          <HelpTooltip tooltipKey="psap-tabs" label="Scorecard views" />
        </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  <CardTitle className="flex items-center gap-1.5">
                    Assessment History
                    <HelpTooltip tooltipKey="psap-table" label="Assessments" />
                  </CardTitle>
                ...
                <div data-tour="filters" className="flex items-center gap-2">
                  ...
                  <HelpTooltip tooltipKey="psap-period-filter" label="Period filter" />
                </div>
              </div>
            </CardHeader>
            <CardContent>

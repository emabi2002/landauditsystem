    ...
    <>
      ...
      <PageContainer>
        <div className="space-y-6">
          {/* KPI Cards */}
      <div data-tour="kpi-cards" className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        {kpiData.map((kpi) => (
      ...
      <div data-tour="charts" className="grid gap-6 lg:grid-cols-2">
        ...
        <Card className="p-6 bg-white border-slate-200">
          <h3 className="text-lg font-semibold text-slate-900 mb-4 flex items-center gap-1.5">
            Findings by Risk Rating
            <HelpTooltip tooltipKey="dashboard-charts" label="Findings by Risk Rating" />
          </h3>
        ...
        <Card className="p-6 bg-white border-slate-200">
          <h3 className="text-lg font-semibold text-slate-900 mb-4 flex items-center gap-1.5">
            Engagements by Status
            <HelpTooltip tooltipKey="dashboard-charts" label="Engagements by Status" />
          </h3>
      ...
      <div>
        <h2 className="text-xl font-semibold mb-4 flex items-center gap-1.5">
          Risk &amp; Governance
          <HelpTooltip tooltipKey="dashboard-governance" label="Risk & Governance" />
        </h2>
        <div data-tour="governance-widgets" className="grid gap-6 md:grid-cols-3">
          <RiskProfileWidget />
          <PSAPRatingsWidget />
          <KRACompletionWidget />
        </div>

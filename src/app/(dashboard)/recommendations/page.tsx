    ...
    <>
      <PageHeader
        ...
        actions={
          <div className="flex items-center gap-1.5">
            ...
            <HelpTooltip tooltipKey="publish-recommendation" label="Publish" side="left" />
          </div>
        }
      />
      <PageContainer>
      ...
      <Card data-tour="filters" className="p-4 bg-white border-slate-200">
        <div className="flex items-center gap-4">
          ...
          <HelpTooltip tooltipKey="recommendations-search" label="Search recommendations" />
          ...
          <HelpTooltip tooltipKey="recommendations-priority-filter" label="Priority filter" />
          ...
          <HelpTooltip tooltipKey="recommendations-status-filter" label="Status filter" />
          ...
          <TableHeader>
            <TableRow className="bg-slate-50">
              ...
              <TableHead className="font-semibold">
                <span className="inline-flex items-center gap-1.5">Priority <HelpTooltip tooltipKey="recommendation-priority" label="Priority" /></span>
              </TableHead>
              <TableHead className="font-semibold">
                <span className="inline-flex items-center gap-1.5">Owner <HelpTooltip tooltipKey="action-owner" label="Action Owner" /></span>
              </TableHead>
              <TableHead className="font-semibold">
                <span className="inline-flex items-center gap-1.5">Target Date <HelpTooltip tooltipKey="target-date" label="Target Date" /></span>
              </TableHead>
              <TableHead className="font-semibold">
                <span className="inline-flex items-center gap-1.5">Status <HelpTooltip tooltipKey="recommendations-status-filter" label="Status" /></span>
              </TableHead>

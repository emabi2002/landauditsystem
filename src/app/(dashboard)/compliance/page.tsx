          ...
          <TableHeader>
            <TableRow className="bg-slate-50">
              ...
              <TableHead className="font-semibold">
                <span className="inline-flex items-center gap-1.5">Source <HelpTooltip tooltipKey="compliance-source" label="Source" /></span>
              </TableHead>
              <TableHead className="font-semibold">Level</TableHead>
              <TableHead className="font-semibold">Controls</TableHead>
              <TableHead className="font-semibold">
                <span className="inline-flex items-center gap-1.5">Status <HelpTooltip tooltipKey="compliance-status" label="Status" /></span>
              </TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>

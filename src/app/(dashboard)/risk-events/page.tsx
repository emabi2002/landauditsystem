    ...
    <>
      <PageHeader
        ...
        actions={
          <div className="flex items-center gap-1.5">
            ...
            <HelpTooltip tooltipKey="risk-events-new" label="New Risk Event" side="left" />
          </div>
        }
      />
      <PageContainer>
      ...
      <Tabs defaultValue="all" className="space-y-4">
        <div className="flex items-center gap-2">
          <TabsList data-tour="tabs" className="bg-slate-100">
          ...
          <HelpTooltip content="Switch between all events, pending actions, Secretary directives and a breakdown by source." label="Event views" />
        </div>
          ...
          <Card data-tour="filters">
            <CardContent className="pt-4">
              <div className="flex flex-col md:flex-row gap-4">
                ...
                <HelpTooltip tooltipKey="risk-events-search" label="Search events" />
                ...
                <HelpTooltip tooltipKey="risk-events-source" label="Filter by source" />
                ...
                <HelpTooltip tooltipKey="risk-events-status" label="Filter by status" />
                ...
                <HelpTooltip tooltipKey="risk-events-priority" label="Filter by priority" />
                <Button
                  variant="outline"
                  size="sm"
                  onClick={() => {

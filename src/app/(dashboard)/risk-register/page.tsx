    ...
    <>
      <PageHeader
        ...
        actions={
          <>
            ...
            <HelpTooltip tooltipKey="risk-register-new" label="Add Risk" side="left" />
          </>
        }
      />
      <PageContainer>
      ...
      <Tabs defaultValue="register" className="space-y-4">
        <div className="flex items-center gap-2">
          ...
          <HelpTooltip tooltipKey="risk-register-tabs" label="Register views" />
        </div>
              ...
              <div className="flex flex-wrap gap-4">
                <div className="flex-1 min-w-[200px] flex items-center gap-1.5">
                  <Input
                    ...
                    className="w-full"
                  />
                  <HelpTooltip tooltipKey="risk-register-search" label="Search risks" />
                </div>
                ...
                <HelpTooltip tooltipKey="risk-category-filter" label="Category filter" />
          ...
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-1.5">
                Risk Heat Map
                <HelpTooltip tooltipKey="risk-register-heatmap" label="Heat Map" />
              </CardTitle>
              <CardDescription>

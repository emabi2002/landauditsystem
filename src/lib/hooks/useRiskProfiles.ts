...
type RiskProfileInsert = Database['public']['Tables']['audit_risk_profiles']['Insert']
type RiskProfileUpdate = Database['public']['Tables']['audit_risk_profiles']['Update']
type RiskProfileItem = Database['public']['Tables']['audit_risk_profile_items']['Row']
type RiskProfileItemInsert = Database['public']['Tables']['audit_risk_profile_items']['Insert']

...
type StrategicKRA = Database['public']['Tables']['strategic_kras']['Row']
type StrategicKRAInsert = Database['public']['Tables']['strategic_kras']['Insert']
type KRAActivity = Database['public']['Tables']['kra_activities']['Row']
type KRAActivityInsert = Database['public']['Tables']['kra_activities']['Insert']
type KRAQuarterlyStatus = Database['public']['Tables']['kra_activity_quarterly_status']['Row']
type KRAQuarterlyStatusInsert = Database['public']['Tables']['kra_activity_quarterly_status']['Insert']

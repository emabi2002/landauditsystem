    ...
    try {
      const { error } = await supabase
        ...
        .insert({
          ...
          risk_owner_id: (riskOwnerId && riskOwnerId !== 'none') ? riskOwnerId : null,
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Select value={status} onValueChange={setStatus}>
                ...
                <SelectContent>
                  {/* Values must match the audit_risk_profile_items_status_check
                      DB constraint, which only permits 'Open' and 'Closed'. */}

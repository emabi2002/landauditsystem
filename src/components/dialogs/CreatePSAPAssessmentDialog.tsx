                ...
                <table className="w-full">
                  ...
                  <tbody>
                    {standards.map((standard) => {
                      ...
                      const weighted = (score * standard.weighting).toFixed(2)
                      return (
                        <tr key={standard.id} className="border-t">
                          <td className="p-2 text-sm">{standard.standard_no}</td>
                          <td className="p-2 text-sm">
                            <div className="font-medium">{standard.title}</div>
                            <div className="text-xs text-slate-500">{standard.description}</div>
                          </td>
                          <td className="p-2 text-center text-sm font-mono">{standard.weighting}</td>
